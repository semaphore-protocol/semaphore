...
import { Semaphore, generateMerkleProof, genExternalNullifier, FullProof, MerkleProof } from "@zk-kit/protocols"
...
test("Should create semaphore full proof", async () => {
    ...
    const packedProof = await SemaphoreContract.packProof(solidityProof.a, solidityProof.b, solidityProof.c)
