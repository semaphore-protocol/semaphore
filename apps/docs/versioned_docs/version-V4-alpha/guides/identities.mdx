...
In order to join a [Semaphore group](/V4-alpha/glossary#semaphore-group), a user must first create a [Semaphore identity](/V4-alpha/glossary#semaphore-identity).
