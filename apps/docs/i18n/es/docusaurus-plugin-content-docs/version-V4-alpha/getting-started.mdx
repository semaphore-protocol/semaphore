...
:::info
Los templates soportados son: [`contracts-hardhat`](https://github.com/semaphore-protocol/semaphore/tree/feat/semaphore-v4/packages/cli-template-contracts-hardhat), [`monorepo-ethers`](https://github.com/semaphore-protocol/semaphore/tree/feat/semaphore-v4/packages/cli-template-monorepo-ethers), [`monorepo-subgraph`](https://github.com/semaphore-protocol/semaphore/tree/feat/semaphore-v4/packages/cli-template-monorepo-subgraph).
:::

:::info
El CLI [`semaphore`](https://github.com/semaphore-protocol/semaphore/tree/feat/semaphore-v4/packages/cli) también se puede utilizar para obtener información de los grupos que existen dentro de las redes soportadas por Semaphore (por ejemplo: `semaphore get-groups --network sepolia`).
:::
...
2. Vaya a la carpeta `apps/contracts` y despliegue su contrato.
    ...
    :::note
    Revise las direcciones de los contratos de Semaphore [aquí](/V4-alpha/deployed-contracts).
    :::
...
:::información
Si desea ver el código de una aplicación completa creada sobre Semaphore, consulte el [repositorio](https://github.com/semaphore-protocol/boilerplate/tree/version/4). Para obtener más información sobre las bibliotecas principales, continúe leyendo las siguientes guías.
:::
