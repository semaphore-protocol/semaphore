...
export default class Identity {
    ...
    public generateCommitment(): bigint {
        return poseidon([poseidon([this._nullifier, this._trapdoor, this.chainID])])
    }
    ...
    public toString(): string {
        return JSON.stringify([this._trapdoor.toString(16), this._nullifier.toString(16), this.chainID.toString(16)])
    }
}
