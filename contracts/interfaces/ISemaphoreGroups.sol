...
interface ISemaphoreGroups {
  ...
  event GroupAdded(uint256 indexed id, uint8 depth);
  ...
  function getRoot(uint256 _groupId) external view returns (uint256);

  /// @dev Returns the depth of the tree of a group.
  /// @param _groupId: Id of the group.
  /// @return Depth of the group tree.
  function getDepth(uint256 _groupId) external view returns (uint256);

  /// @dev Returns the number of members of a group.
  /// @param _groupId: Id of the group.
  /// @return Size of the group.
  function getSize(uint256 _groupId) external view returns (uint256);
}
