...
All members of our community are expected to follow our [Code of Conduct](/docs/code-of-conduct). Please make sure you are welcoming and friendly in all of our spaces.
...
4. Make sure to check out the [Style Guide](/docs/contributing#style-guide) and ensure that your code complies with the rules.
