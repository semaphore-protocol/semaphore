...
// The third part covers the generation of a nullifier, i.e. the hash of the secret used to
// derive the public key and the scope of the proof. The nullifier is used to prevent the same
